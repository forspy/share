...
using namespace std;
void call_1(String_medium&);
void call_2(String_medium);
int main()
{
	String_medium headline1("hello world");
...
void call_2(String_medium r)//这里没有引用啊，为什么和原型不一样也行啊？不是的啊，你的实参和形参会发送拷贝的，只要发送拷贝，它就会调用，明白了，刚才想歪了！！
